    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-center bg-bg-base p-4">
            <div className="pointer-events-none absolute inset-0 -z-10">
                ...
                <div className="absolute top-1/3 left-1/4 h-[320px] w-[320px] rounded-full bg-accent-mint/8 blur-[100px] opacity-40" />
                <div className="absolute bottom-0 right-1/4 h-[360px] w-[360px] rounded-full bg-accent-emerald/10 blur-[110px] opacity-40" />
            </div>
                ...
                appearance={{
                    ...
                    elements: {
                        ...
                        formResendCodeLink:
                            "!text-accent-mint !font-dm-sans !text-[12.5px] !font-medium !hover:!text-accent-emerald",
                        formButtonPrimary:
                            "!h-11 !rounded-xl !bg-accent-emerald-strong !hover:!bg-accent-emerald !text-text-primary !font-dm-sans !text-[13.5px] !font-semibold !tracking-tight !shadow-[0_8px_24px_-8px_rgba(16,185,129,0.55)] !transition-all !duration-200 !-mt-1.5 !mb-4",
                        formButtonReset:
